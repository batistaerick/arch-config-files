...
AWS_DEFAULT_RETURN_COMMAND="$(aws_menu_return_command "$@")"
...
run_in_kitty() {
  ...
  effective_return_command="${return_command:-${AWS_MENU_RETURN_COMMAND:-$AWS_DEFAULT_RETURN_COMMAND}}"
